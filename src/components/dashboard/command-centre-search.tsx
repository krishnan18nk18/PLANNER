...
export function CommandCentreSearch() {
  return (
    <div className="relative glass-card rounded-full p-2 border-border/20 shadow-2xl">
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-2">
            ...
            <Button className="rounded-full h-10 w-24 bg-gradient-to-r from-blue-500 to-purple-600 text-white hover:scale-105 transition-transform shadow-lg">
